...
#if (DMA_BUFFER_LENGHT == 64)
        const fractcomplex twiddleFactors_FFT[] __attribute__ ((space(auto_psv), aligned (DMA_BUFFER_LENGHT*2)))=
        {
...
#endif
#if (DMA_BUFFER_LENGHT == 512 )
        const fractcomplex twiddleFactors_FFT[] __attribute__ ((space(auto_psv), aligned (DMA_BUFFER_LENGHT*2*2))) =
        {
...
#if (DMA_BUFFER_LENGHT == 64)
        const fractcomplex twiddleFactors_IFFT[] __attribute__ ((space(auto_psv), aligned (DMA_BUFFER_LENGHT*2)))=
        {
...
#endif
#if (DMA_BUFFER_LENGHT == 512 )
        const fractcomplex twiddleFactors_IFFT[] __attribute__ ((space(auto_psv), aligned (DMA_BUFFER_LENGHT*2*2))) =
        {
